...
def create_prompt(
    ...
    prompt = f"""
คุณคือผู้เชี่ยวชาญด้านการวิเคราะห์หุ้น
**คำสั่ง:** วิเคราะห์ข้อมูลทางการเงินของบริษัท {ticker} และสรุปภาพรวมในรูปแบบย่อหน้าเดียวที่คมชัดและลึกซึ้ง
**ข้อมูลที่มี:**
{data_string}

**กฎเหล็ก (Guardrails):**
1.  **ห้าม** สร้างข้อมูลหรือตัวเลขใดๆ ที่ไม่มีอยู่ใน `ข้อมูลที่มี` โดยเด็ดขาด
2.  วิเคราะห์จากข้อมูลที่ให้มาเท่านั้น
3.  หากข้อมูลในบางหัวข้อไม่เพียงพอต่อการสรุป ให้ระบุว่า "ข้อมูลไม่เพียงพอที่จะประเมิน"
4.  คำตอบทั้งหมดต้องเป็นภาษาไทย

**กระบวนการคิด (Chain of Thought):**
1.  **ประเมินความสามารถในการทำกำไรและเสถียรภาพ:** ดูที่ ROE, Profit Margins และ Debt to Equity Ratio เพื่อประเมินว่าบริษัทแข็งแกร่งและจัดการหนี้สินได้ดีเพียงใด
2.  **ประเมินการเติบโต:** พิจารณา 3-Year Revenue Trend และ CAGR (ถ้ามี) เพื่อดูทิศทางการเติบโตของรายได้
3.  **ประเมินมูลค่า (Valuation):** มองที่ P/E และ P/B Ratio เพื่อประเมินว่าราคาหุ้นถูกหรือแพงเมื่อเทียบกับกำไรและมูลค่าทางบัญชี
4.  **สรุปภาพรวม:** สังเคราะห์ข้อมูลทั้งหมดเพื่อสร้างบทสรุปที่กระชับและให้ข้อมูลเชิงลึกเกี่ยวกับสถานะทางการเงินของบริษัท
